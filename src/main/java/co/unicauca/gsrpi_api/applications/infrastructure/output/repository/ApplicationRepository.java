...
public interface ApplicationRepository extends JpaRepository<ApplicationEntity, Long> {
    ...
    List<ApplicationEntity> findAllByDepartment_Faculty_FacultyIdAndApplicationStatus_StatusApplicationIdOrderByCreateAtAsc(long departmentFacultyFacultyId, long applicationStatusStatusApplicationId);
